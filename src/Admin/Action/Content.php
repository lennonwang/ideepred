 ...
 * @version $Id$
 */
class Admin_Action_Content extends Admin_Action_Entry {
    ...
    public function display(){
    	...
    	$article_list = $model->find($options)->getResultArray();
    	...
    	$options2 = array(
    	    'condition'=>'type=? AND state=?',
    	    'vars'=>array(1,1)
    	); 
    	$sort_list = $sorts->find($options2)->getResultArray();
    	$this->putContext('sort_list', $sort_list);
    	unset($sorts);
